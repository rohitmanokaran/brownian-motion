...
\begin{proof}\uses{thm:ext_of_charFunDual, lem:charFun_gaussianReal}
...
\begin{proof}  \uses{lem:isGaussian_conv}
...
\begin{proof}  \uses{thm:isGaussian_iff_charFunDual_eq}
...
\begin{proof}  \uses{lem:isGaussian_iff_charFun_eq, lem:IsGaussian.memLp_id, lem:covarianceBilin_same_eq_variance}
...
\begin{proof}  \uses{thm:ext_of_charFun, lem:IsGaussian.charFun_eq}
...
\begin{proof}As $f$ is integrable, we can use Fubini theorem to obtain that
...
\begin{proof}  \uses{lem:integral_eval_pi}
...
\begin{proof}  \uses{lem:charFun_gaussianReal}
...
\begin{proof}  \uses{lem:isGaussian_iff_gaussian_charFun, lem:charFun_stdGaussian, lem:isProbabilityMeasure_stdGaussian}
...
\begin{proof}  \uses{lem:integral_id_stdGaussian}
...
\begin{proof}  \uses{lem:covMatrix_stdGaussian}
...
\begin{proof}  \uses{lem:isGaussian_stdGaussian, lem:isGaussian_add_const, lem:isGaussian_map}
...
\begin{proof}  \uses{lem:isGaussian_multivariateGaussian, lem:IsGaussian.charFun_eq, lem:integral_id_multivariateGaussian, lem:covMatrix_multivariateGaussian}
...
\begin{proof}  \uses{lem:map_eq_of_modification}
