...
\begin{proof}  \uses{lem:localizingSequence_const_top}
...
\begin{proof}Let $X \in P_{\mathrm{loc}}$.
...
\begin{proof}  \uses{lem:localizingSequence_min}
...
\begin{proof}  \uses{lem:isLocalizingSequence_of_isPreLocalizingSequence}
...
\begin{proof}  \uses{lem:locally_of_isPreLocalizingSequence, lem:isStable_locally, lem:isPreLocalizingSequence_of_isLocalizingSequence}
...
\begin{proof}  \uses{lem:locally_locally, lem:locally_mono}
...
\begin{theorem}\label{thm:IsLocalMartingale.eq_zero_of_continuous_finiteVariation}
...
\begin{proof}  \uses{lem:Submartingale.classDL, lem:Martingale.submartingale_convex_comp, lem:uniformIntegrableIffNorm}
...
\begin{proof}  \uses{lem:Submartingale.classD_iff_uniformIntegrable, lem:uniformIntegrableIffNorm, lem:classD_iff_norm, cor:Martingale.submartingale_norm}
...
\begin{proof}  \uses{lem:uniformIntegrableDominatedSingleton}
...
\begin{proof}  \uses{lem:isStoppingTime_leastGT}
