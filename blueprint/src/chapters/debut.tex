...
\begin{proof}The ``monotone decreasing'' condition is the only non-trivial part of the statement: without it it would just be the definition of $S_\delta$.
...
\begin{proof}Similar to the proof of Lemma~\ref{lem:InfClosed.mem_countableInfClosure_iff}.
\end{proof}
...
\begin{proof}  \uses{def:IsCompactSystem}
...
\begin{proof}  \uses{lem:isCompactSystem_isCompact_isClosed}
...
\begin{proof}  \uses{lem:IsCompactSystem.pi}
...
\begin{proof}  \uses{lem:IsCompactSystem.sigma}
...
\begin{proof}  \uses{lem:isPavingAnalytic_of_measurableSet_generateFrom, lem:IsPavingAnalytic.iUnion, lem:isPavingAnalytic_of_prop}
...
\begin{proof}  \uses{lem:MeasurableSet.isPavingAnalytic_image2_prod, lem:isPavingAnalytic_fst_of_image2_prod_measurableSet_Icc}
...
\begin{proof}  \uses{lem:IsMeasurableAnalyticFor.isMeasurableAnalytic, lem:IsMeasurableAnalytic.nullMeasurableSet}
